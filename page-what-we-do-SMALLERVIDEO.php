...
<div class="sticky-wrap">
     <section class="header lazy" data-src="<?php echo get_bloginfo('stylesheet_directory'); ?>/assets/images/page-<?php echo $post_slug;?>/header-bg.jpg">
         <div class="container">
             <div class="row">
                 <div class="col-lg-7">
                    <h1>WE MAKE SECURITY THE <span class="red">EASIEST THING</span> TO DO IN THE CLOUD</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                 <div class="col-lg-10 mx-auto text-center">
                    ...
                    <p class="large">Agent-based approaches add complexity, costing time and money. Worse still, micro-segmentation that uses agents merely manages IP table's firewall rules on workloads and doesn't provide true security.</p>
                    <p class="large">The agentless ShieldX approach provides a frictionless means to discover, automate, and microsegment all the way to layer 7. By sitting at the network layer, all workloads and applications are visible, and policies with native security control are generated in minutes—without the need to install a burdensome agent.</p>
                </div>
            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-6 flex-align-center">
                        <div>
                            ...
                            <!-- <p class="white t3">— Coming from Forrester soon</p> -->
                      </div>
                  </div>
              </div>
          </div>    
      ...
      <section class="secure-data">
         <div class="container">
             <div class="row">
                ...
                <h3>ShieldX uses business logic, not ports and protocols,<br class="medium"> to provide one view into everything</h3>
                 ...
                 <div class="business-logic-slider-wrap row">
                    ...
                    <div class="col-lg-12">
                        <div class="business-logic-slider">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <ul class="slick-bullets">
                                            ...
                                            <li>ShieldX continuously looks for new workloads, networks, and load balancers and reacts at cloud speed to determine intent</li>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul class="slick-bullets">
                                            ...
                                            <li>Scale out required microservices to the scale of need</li>
                                            <li>Scale back when demand isn’t as high to reduce costs without interrupting traffic</li>
                            ...
                            <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <ul class="slick-bullets">
                                            <li>ShieldX learns how a multi-cloud behaves and shows anomalies based on knowledge of normal activity</li>
                                            <li>Anomalous activity is quarantined, preventing attacks from spreading, without stopping work</li>
                                            <li>ShieldX takes the headache out of managing complex multi-cloud environments to save
time</li>
...
<!--                     <div class="what-other-are-saying">
        ...
        <section>
            <!--  <div class="sixteen-nine">     
                <div class="content"> -->
                    <div class="container section-title mb-n5">  
                        <div class="row">
                    ...
                    <div class="container-fluid px-0 py-5 black-bg">
                              <div class="row mx-0">
                              <div class="col-md-10 col-lg-9 mx-auto col-12 px-0">
                                        <div class="sixteen-nine">
                                                  <div class="content">
                                                            <div class="play-wrap">
                                                            <video style="width: 100%!important; height: auto;" poster="<?= get_bloginfo('template_directory'); ?>/assets/video/cloudUpdate-placeholder.jpg" preload="meta" src="<?= get_bloginfo('template_directory'); ?>/assets/video/CloudUpdateAndMusic-1.mp4"></video> 
                         ...
                         <div class="col-md-11 text-center mx-auto">   
                            <div class="always-evolving-slider pb-3 mb-5">   
                                ...
                                <div class="item">
                                       ...
                                       <p class="bullets"><span>Cloud-native microservers auto scale to any environment</span></p>
        ...
        <section class="bolstered">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h2><span class="green">Bolstering networking operations</span> in the multi&#8209;cloud</h2>
                    </div>
                    <div class="col-lg-10">
